...
//看板娘样式设置
live2d_settings['waifuSize']            = '330x330';    // 看板娘大小，例如 '280x250', '600x535'
...
live2d_settings['waifuEdgeSide']        = 'left:300';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
// 其他杂项设置
live2d_settings['l2dVersion']           = '1.0.6';        // 当前版本
