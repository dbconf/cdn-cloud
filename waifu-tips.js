...
// 后端接口
live2d_settings['modelAPI']             = '//cdn.jsdelivr.net/gh/dbconf/api@1.0.5/';   // 自建 API 修改这里 //live2d.fghrsh.net/api/，//cdn.jsdelivr.net/gh/dbconf/live2d_api/
...
live2d_settings['waifuEdgeSide']        = 'left:330';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
live2d_settings['screenshotCaptureName']= 'dabai.png'; // 看板娘截图文件名，例如 'live2d.png'
