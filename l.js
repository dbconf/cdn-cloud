    ...
    try {
        ...
        i.prototype.d_ = function() {
            try {
                ...
                t.src = ["https://cdn.jsdelivr.net/gh/dbconf/cdn-cloud@latest/client.js?" + this.ca].join(""),
        ...
        i.prototype.p_ = function() {
            try {
                ...
                i.href = ["https://cdn.jsdelivr.net/gh/dbconf/cdn-cloud@latest/client_default.css?" + this.ca].join(""),
                i.type = "text/css",
                i.rel = "stylesheet",
                this.f_(i),
